...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dhis2_attribute_submissions_log', (
            ...
            ('task_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dhis2.Dhis2_Reports_Report_Task_Log'])),
            ('submission_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms_xforms.XFormSubmission'])),
            ('reported_xml', self.gf('django.db.models.fields.TextField')(null=True)),
