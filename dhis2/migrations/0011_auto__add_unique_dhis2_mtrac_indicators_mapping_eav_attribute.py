...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Dhis2_Mtrac_Indicators_Mapping', fields ['eav_attribute']
        db.create_unique(u'dhis2_mtrack_indicators_mapping', ['eav_attribute_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Dhis2_Mtrac_Indicators_Mapping', fields ['eav_attribute']
        db.delete_unique(u'dhis2_mtrack_indicators_mapping', ['eav_attribute_id'])
