...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dhis2_Reports_Submissions_Log.dhis2_result'
        db.add_column(u'dhis2_attribute_submissions_log', 'dhis2_result',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)

        # Adding field 'Dhis2_Reports_Submissions_Log.dhis2_description'
        db.add_column(u'dhis2_attribute_submissions_log', 'dhis2_description',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dhis2_Reports_Submissions_Log.dhis2_result'
        db.delete_column(u'dhis2_attribute_submissions_log', 'dhis2_result')

        # Deleting field 'Dhis2_Reports_Submissions_Log.dhis2_description'
        db.delete_column(u'dhis2_attribute_submissions_log', 'dhis2_description')
    ...
    models = {
        ...
        'dhis2.dhis2_reports_submissions_log': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'dhis2_description': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'dhis2_result': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
