...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dhis2_Mtrac_Indicators_Mapping.dhis2_name'
        db.delete_column(u'dhis2_mtrack_indicators_mapping', 'dhis2_name')

        # Deleting field 'Dhis2_Mtrac_Indicators_Mapping.dhis2_url'
        db.delete_column(u'dhis2_mtrack_indicators_mapping', 'dhis2_url')


        # Renaming column for 'Dhis2_Mtrac_Indicators_Mapping.mtrac_id' to match new field type.
        db.rename_column(u'dhis2_mtrack_indicators_mapping', 'mtrac_id', 'mtrac_id_id')
        # Changing field 'Dhis2_Mtrac_Indicators_Mapping.mtrac_id'
        db.alter_column(u'dhis2_mtrack_indicators_mapping', 'mtrac_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eav.Attribute']))
        # Adding index on 'Dhis2_Mtrac_Indicators_Mapping', fields ['mtrac_id']
        db.create_index(u'dhis2_mtrack_indicators_mapping', ['mtrac_id_id'])


    def backwards(self, orm):
        # Removing index on 'Dhis2_Mtrac_Indicators_Mapping', fields ['mtrac_id']
        db.delete_index(u'dhis2_mtrack_indicators_mapping', ['mtrac_id_id'])


        # User chose to not deal with backwards NULL issues for 'Dhis2_Mtrac_Indicators_Mapping.dhis2_name'
        raise RuntimeError("Cannot reverse this migration. 'Dhis2_Mtrac_Indicators_Mapping.dhis2_name' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Dhis2_Mtrac_Indicators_Mapping.dhis2_url'
        raise RuntimeError("Cannot reverse this migration. 'Dhis2_Mtrac_Indicators_Mapping.dhis2_url' and its values cannot be restored.")

        # Renaming column for 'Dhis2_Mtrac_Indicators_Mapping.mtrac_id' to match new field type.
        db.rename_column(u'dhis2_mtrack_indicators_mapping', 'mtrac_id_id', 'mtrac_id')
        # Changing field 'Dhis2_Mtrac_Indicators_Mapping.mtrac_id'
        db.alter_column(u'dhis2_mtrack_indicators_mapping', 'mtrac_id', self.gf('django.db.models.fields.IntegerField')(null=True))
