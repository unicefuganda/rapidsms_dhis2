...
urlpatterns = patterns('dhis2.views',
    ...
    url(r'^(\d+)/non-hmis-facilities$', login_required(task_non_hmis_facilities),name='task_non_hmis_facilities'),                
    url(r'^(\d+)/non-hmis-indicators$', login_required(task_non_hmis_indicators),name='task_non_hmis_indicators'),                
